...
namespace OnlineExamApp.Client
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Create an instance of ExamDbc
            services.AddMvc();
            services.AddDbContext<examlibrarydbContext>(o => o.UseMySQL(Configuration.GetConnectionString("DefaultConnection")));
                ...
                x.Events = new JwtBearerEvents
                {
                    OnTokenValidated = context =>
                    {
                       ...
                       // var userId = int.Parse(context.Principal.Identity.Name);
                        var user = userService.GetByEmailId(context.Principal.Identity.Name);
                        if (user == null)
                        {
